...
public class BookController {
    ...
    public void rentBook(@PathVariable UUID bookId, @RequestBody Book rentedBook) {
        BookService.rentBook(bookId, rentedBook.getRenterId(), rentedBook.getRentDuration());
    }
}